...
<c:choose>
	<c:when test="${searchType == null}">
		<c:choose>
			...
			<c:otherwise>
				<a
					href="myReview?uno=${sessionScope.uNo}&page=
	...
	<c:otherwise>
		...
		<c:choose>
			...
			<c:otherwise>
				<a
					href="myReview?uno=${sessionScope.uNo}&searchType=${searchType}&searchValue=${searchValue}&page=
									${(pageInfo.currentBlock-1)*pageInfo.pagesPerBlock }">
					<img src="resources/img/prev.png">
				</a>
			</c:otherwise>
		...
		<c:choose>
			...
			<c:otherwise>
				<a
					href="myReview?searchType=${searchType}&searchValue=${searchValue}&page=
									${pageInfo.currentBlock * pageInfo.pagesPerBlock + 1 }">
					<img src="resources/img/next.png">
				</a>
			</c:otherwise>
